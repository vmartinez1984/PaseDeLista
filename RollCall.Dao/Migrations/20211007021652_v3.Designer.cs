...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RollCall.Persistence.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Administrador",
                            PhotoInBase64 = "",
                            RegistrationDate = new DateTime(2021, 10, 6, 21, 16, 50, 97, DateTimeKind.Local).AddTicks(2418)
                        });
                });
            ...
            modelBuilder.Entity("RollCall.Persistence.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "123456",
                            RegistrationDate = new DateTime(2021, 10, 6, 21, 16, 50, 110, DateTimeKind.Local).AddTicks(6226),
                            RolId = 1
                        });
                });
            ...
            modelBuilder.Entity("RollCall.Persistence.Entities.SecurityQuestion", b =>
                {
                    b.HasOne("RollCall.Persistence.Entities.Employee", null)
